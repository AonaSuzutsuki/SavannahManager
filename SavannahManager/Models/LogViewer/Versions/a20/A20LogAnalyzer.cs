...
namespace _7dtd_svmanager_fix_mvvm.Models.LogViewer.Versions.a20
{
    public class ServerFixesAnalyzer : AbstractLogAnalyzer, ILogAnalyzer
    {
        ...
        {
            return ChatInfoConverter.ConvertChat(line);
        }
    }

    public class A21LogAnalyzer : AbstractLogAnalyzer, ILogAnalyzer
    {
        public const string AnalyzerName = "A21";
    ...
    public class A20LogAnalyzer : AbstractLogAnalyzer, ILogAnalyzer
    {
        public const string AnalyzerName = "A20";
