...
{
    public class A20LogAnalyzer : AbstractLogAnalyzer
    {
        ...
        private static List<PlayerItemInfo> GetPlayerList(Dictionary<string, List<PlayerItemInfo>> playerDict, string id)
        {
